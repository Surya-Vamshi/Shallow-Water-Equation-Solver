...
from SWE_solver_instantaneous import SWE_solver_instantaneous
...
dbdt = dbdt_grid * np.exp(-((T_start - 4 * sigma_t) ** 2) / (2 * sigma_t * sigma_t))
b_static = dbdt * T_start
...
SWE_solver_instantaneous(eta0, qx0, qy0, h, g, T_start, T_end, dx, dy, dt, case, plot_min, plot_max)

print("Completed Instantaneous Source Scenario 1 simulation")
...
print("Completed Instantaneous Source Scenario 2 simulation")
...
print("Completed Instantaneous Source Scenario 3 simulation")
